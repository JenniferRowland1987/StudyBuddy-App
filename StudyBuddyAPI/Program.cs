...
builder.Services.AddDbContext<StudyBuddyDbContext>(options => options.UseSqlServer(configuration.GetConnectionString("StudyBuddyDb"))); // Make sure to use the right name
// END OF NEW LINES
